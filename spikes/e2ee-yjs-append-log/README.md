...
This proves that a custom encrypted Yjs append-log provider is viable as a starting v1 spike for a single Markdown room, including basic durable replay from an opaque encrypted append log.

## What this does not prove yet

- Large-room performance or append-log compaction.
- Server-assigned sequence integrity, drop detection, or replay protection.
